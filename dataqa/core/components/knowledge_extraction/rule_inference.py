...
rule_updater_prompt_template = """
As an AI assistant, you are given a list of business rules that are used to generate SQL queries.
Your task is to update business rules based on below information.
1. User question
2. Generated SQL query by LLM based on schema, current collection of rules and user question
3. Expected ground truth SQL generated by analyst with domain knowledge of business rules
4. Current collection of business rules
...
By comparing generated SQL and expected SQL, and checking the current collection of business rules, you can update business rules by
- add new business rules
- rephrase current business rules
- DO NOT delete any current business rule
...
Current collection of business rules:
{current_rules}

Please start comparing and reasoning, and output updated business rules."""
